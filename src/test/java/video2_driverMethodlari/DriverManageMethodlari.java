...
public class DriverManageMethodlari {
    ...
    public static void main(String[] args) {
        ...
        // driver.manage().timeouts() --> driver ile birlikte timeouts ları yönetebiliyoruz yani beklemeleri yönetebiliyoruz

        //driver.manage().window().getSize(); içerisinde olduğumuz sayfanın ölçülerini getirecektir
        ...
        System.out.println(driver.manage().window().getSize().height); // 708 genislik ve yukseklik degerlerini ayri ayri da alabiliriz
